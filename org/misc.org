...
(global-set-key (kbd "C-c j") 'shortcut-prefix)
...
(define-prefix-command 'shortcut-prefix)
(define-key shortcut-prefix (kbd "f") 'find-name-dired)
(define-key shortcut-prefix (kbd "F") 'projectile-find-file)
(define-key shortcut-prefix (kbd "g") 'rg-thing-at-point)
(define-key shortcut-prefix (kbd "G") 'rg-thing-at-point-default)
(define-key shortcut-prefix (kbd "e") 'open-fold)
(define-key shortcut-prefix (kbd "b") 'pop-tag-mark)
(define-key shortcut-prefix (kbd "m") 'magit-status)

(define-key shortcut-prefix (kbd "l") 'org-store-link)
(define-key shortcut-prefix (kbd "C-l") 'org-insert-link)
(define-key shortcut-prefix (kbd "a") 'org-agenda)
(define-key shortcut-prefix (kbd "c") 'org-capture)

(define-key shortcut-prefix (kbd "s") 'swiper-isearch-thing-at-point)
(define-key shortcut-prefix (kbd "r") 'counsel-recentf)
(define-key shortcut-prefix (kbd "i") 'counsel-imenu)
(define-key shortcut-prefix (kbd "C-r") 'resume-ivy-with-prefix-arg)
...
;;
(define-key shortcut-prefix (kbd "=") 'er/expand-region)

;; my define function map
(define-key shortcut-prefix (kbd "1") 'store-cur-file-name)
#+END_SRC
* Appendix
  #+BEGIN_SRC shell
